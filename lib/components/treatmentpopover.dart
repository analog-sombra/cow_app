...
class TreatmentPopMenuButton extends StatelessWidget {
  final int cowid;
  const TreatmentPopMenuButton({super.key, required this.cowid});
        ...
        children: [
          ...
          ElevatedButton.icon(
            ...
            onPressed: () async {
              try {
                context.pop();
                await cowTreatmentAlert(context, ref, cowid);
              } catch (e) {

...
class CowDetailsPage extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    String capitalize(String s) {
      if (s.isEmpty) return s; // Return empty string if input is empty
                                        ...
                                        Opacity(
                                          ...
                                          child: SlideTransition(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Text(
                                                "ગાયનું નામ ${cow["cowname"]}, ઉંમર ${getYears(cow["birthdate"])} છે અને તેનું વજન ${cow["weight"]} કિગ્રામ છે. છેલ્લી કૃમિનાશક તારીખ ${cow["cow_health_report"].length != 0 ? cow["cow_health_report"][0]["last_deworming_date"] == null ? "-" : DateFormat('d-MM-yyyy').format(
                                                    DateTime.parse(cow[
                                                            "cow_health_report"][0]
                                                        [
                                                        "last_deworming_date"]),
                                                  ) : "-"} છે, અને છેલ્લું રસીકરણ ${cow["cow_health_report"].length != 0 ? cow["cow_health_report"][0]["last_vaccine_date"] == null ? "-" : DateFormat('d-MM-yyyy').format(
                                                    DateTime.parse(
